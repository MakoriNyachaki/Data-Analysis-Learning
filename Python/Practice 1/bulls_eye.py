# -*- coding: utf-8 -*-
"""
Created on Sun Oct  8 07:14:12 2023

@author: Lenovo

Draws a target with a bull's eye using
the number of rings specified by the user
...
# Create the graphis window and get the canvas
